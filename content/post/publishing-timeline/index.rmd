...
I've been keeping track of my own paper submissions over time^[This data is imperfect. Some of these papers have been submitted more than seen below, but I forgot to log the submission. Oh well!] and thought it would be interesting to visualize the lifecycle of these projects to get a sense of what the publication process looks like.   
...
Getting to an R&R is only part of the battle: actually *revising* the paper to meet reviewer comments takes time, as does the time the journal and reviewers spend evaluating your revisions. With `worlds-apart`, my first publication, I got a rejection from the first journal I tried after 45 days. I spent about a month and a half making revisions based on reviewer comments, then sent it out again to a new journal where I got an R&R after about another 45 days. It took me about a month to do the revisions (this was August, before start of school, plenty of free time), but then I had to wait about *4 months* to get a decision back on that R&R. I spent another 20 days or so turning that around, and then the final decision took about a month. 
...
The other big implication is that students face a big trade-off in terms of ambition of publication venue and having pre-tenure publications. Do you send the paper to the top-3 journal with the miniscule acceptance rates and risk not having anything for the market, or do you send it to a lower-tier journal but miss out on a potential "big hit" that could have big implications for your career down the line? 
