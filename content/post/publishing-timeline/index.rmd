...
The first, obvious barrier to publication is getting past reviewers in the initial submission stage and to an invitation to revise and resubmit (R&R). One thing that jumps out is how much papers can vary in clearing the initial submission hurdle. Some papers can take a long time to find a home; `dyads` has been submitted to four different journals (actually, I think I'm missing a submission here) without landing an invitation to revise. Other papers, like `hierarchy-order`, landed an R&R on the first try. 
...
This is mostly a depressing post but that's the nature of the topic. My main advice to graduate students on this front would be to pursue co-author opportunities early, with other graduate students or with faculty. The best strategy probably involves developing: a) your own, high-investment, shoot-for-the-stars projects related to your dissertation, and b) co-authored, lower-investment projects that are faster out the door. There are only so many hours in the day, though, and I recognize this is a tall order. The last thing I'll say is that there's no perfect paper, and I think there's a risk in waiting too long to send things out. 
