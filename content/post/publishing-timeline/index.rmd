...
Getting to an R&R is only part of the battle: actually *revising* the paper to meet reviewer comments takes time, as does the time the journal and reviewers spend evaluating your revisions. With my first publication, `worlds-apart`, I received a rejection from a journal after about 45 days. I spent about a month and a half making revisions based on reviewer comments, then sent it out again to a new journal where I got an R&R after roughly another 45 days. It took me about a month to do the revisions (this was August, before start of school, plenty of free time), but then I had to wait about *4 months* to get a decision back on that R&R. I spent another 20 days or so turning that around, and then the final decision took about a month. 
